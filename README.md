...
}Perfeito, confirma exatamente o exemplo que eu tinha colocado (name e email). O README já está correto então — não precisa de nenhum ajuste no exemplo de JSON.
Aqui está a versão final consolidada, em texto puro:
# Envio de E-mail via Gmail
